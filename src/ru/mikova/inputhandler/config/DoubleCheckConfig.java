package ru.mikova.inputhandler.config;
 ...
 */
public final class DoubleCheckConfig {
     ...
     */
    private DoubleCheckConfig(Builder builder) {
    ...
    public static class Builder {
         ...
         */
        public DoubleCheckConfig build() {
            return new DoubleCheckConfig(this);
        }
    }
